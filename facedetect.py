...
facedetect = cv2.CascadeClassifier(r'E:\face detection\haarcascade_frontalface_default.xml')
...
#frame = cv2.imread(r"E:\DCIM\images\adobe lightroom\IMG-20220723-WA0016.jpg")
#frame=cv2.imread(r"E:\sad.jpeg")
frame=cv2.imread(r"E:\angry.jpg")
#frame=cv2.imread(r"E:\fear.jpg")
